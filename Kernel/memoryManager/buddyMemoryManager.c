...
#define ORIGIN_PTR (void*)(0x900000)
#define MEMALLOCABLE 0x100000

#define MIN_ALLOC_LOG2 4
#define MIN_ALLOC ((size_t)1 << MIN_ALLOC_LOG2)

#define MAX_ALLOC_LOG2 12 //8 KB
...
static int update_max_ptr(uint8_t *new_value)
{
  if (new_value > max_ptr)
  {
    ...
    // comente mas abajo
    if (new_value > base_ptr + MEMALLOCABLE)
      return 0;
    // if (brk(new_value)) {
    //   return 0;
    // }
...
void *malloc(unsigned int request)
{
